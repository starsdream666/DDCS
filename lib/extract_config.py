config = [
    ...
    ("No services", ""),
    ("No source was found in this build's metadata", ""),
    ("No tags", "无标签"),
    ...
    ("Run the following command in a terminal to create a deployment", ""),
    ("Run the following command in a terminal to run a container in a pod", ""),
    (
