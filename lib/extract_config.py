config = [
    ("\u2009*", None),
    ("{0}\u2009*", None),
    ("Press enter or space to select a node.{0} Press delete to remove it and escape to cancel. ", " Enter 键或空格键选择一个节点。{0}按 Delete 键将其删除，按 Esc 键取消。"),
    ...
    ("Change preferences", ""),
    ("Downloading update ({0}%)", "正在下载更新（{0}%）"),
    ("Installing update. Docker Desktop will restart when the installation is complete.", ""),
    ("Something went wrong whilst downloading the update.", "下载更新时出错。"),
    ("Something went wrong whilst preparing the update.", ""),
    ("Software update", ""),
    ...
    ("Docker {0} Logo", ""),
    ("A powerful, scalable runtime - with zero extra setup", ""),
    ...
    ("View docs", ""),
    ("Accelerate GenAI Workflows with Docker {0}", ""),
    (
    ...
    ("Yes", "是"),
    ("Change Kubernetes cluster configuration?", ""),
    ...
    ("Enable Docker AI", ""),
    ('Enable "Ask Gordon" feature in Docker Desktop and CLI.', "在 Docker Desktop 和 CLI 中启用 Ask Gordon 功能。"),
    ...
    ("Additional components will be downloaded to ~/.docker/bin/inference.", "其他组件将被下载到 ~/.docker/bin/inference 目录中。"),
    ("Enable Docker {0}", ""),
    ("Switch between building and running your containers on your local machine or offload to the cloud.", ""),
    ("Enable Docker {0} GPU Support", ""),
    ...
    ("Toggle WSL engine support", ""),
    ("Enable HCS Engine", ""),
    ("Toggle HCS engine support", ""),
    (
    ...
    ("Enable image analysis with Scout", ""),
    (
    ...
    ("Images are used to run containers in the cloud", ""),
    ("You can either build an image from a Dockerfile, or use an existing image from Docker Hub.", ""),
    ("Containers can use volumes to store data on Docker {0}", ""),
    ("Volumes can be used to store data outside of ephemeral containers.", ""),
    ("Build your container images faster in the cloud", ""),
    (
    ...
    ("Cannot get the list of Docker models", ""),
    ...
    ("Authorized", ""),
    ("Authorize MCP Toolkit to access your {0} account", ""),
    ("Revoke", ""),
    ("Authorize", ""),
    ("Tag:", "标签:"),
    ...
    ("No Docker models from Docker Hub found", ""),
    ("BETA", ""),
    ("Got it", "明白了"),
    ("Driver", "驱动"),
    ("IPv4 subnet", ""),
    ...
    ("Try changing your search or clear it", ""),
    ("Go to catalog", ""),
    ("Tools", "工具"),
    ("Config required", ""),
    ("Secrets required", ""),
    ...
    ("My extensions{0}", ""),
    ("Docker扩展 允许您在 Docker Desktop 中使用第三方工具来扩展其功能。", ""),
    ("Manage extensions", ""),
    ...
    ("IPv4 only", ""),
    ("IPv6 only", "仅 IPv6"),
    ("Based on selected network mode", ""),
    ("Auto (recommended)", ""),
    ...
    (
        "Docker Desktop 会自动检测并使用系统代理。或者可以手动指定代理服务器。{0}{1}支持的代理是 HTTP/HTTPS 和 SOCKS5。 {2}",
        "",
    ),
    (
    ...
    ("WSL 2 提供了比 Hyper-V 后端更好的性能。{0}", ""),
    ("HCS is an experimental backend for Docker Desktop.", ""),
    ("Default", "默认"),
    ("Use containerd for pulling and storing images?", "使用 containerd 拉取和存储镜像?"),
    (
    ...
    ("Getting AI tools", ""),
    ("Cannot get the Docker AI models", ""),
    ("Enable Ask Gordon", ""),
    ("Sign in to use Ask Gordon", ""),
    ("Toolbox", ""),
    ("Loading toolbox", ""),
    ("Error loading toolbox", ""),
    ("No tools available. Try again later.", ""),
    ("Delete history?", ""),
    ("All Gordon conversations will be deleted permanently.", ""),
    ...
    ("Authenticated", ""),
    ("Unauthorized", ""),
    ("Allow the {0} MCP server to use the {1} integration", ""),
    ...
    ("No clients found", ""),
    ("No clients available to be connected with.", ""),
    ...
    ("了解应用程序的依赖关系，分析漏洞，并根据建议的补救选项快速采取行动。 {0} and {1}.", ""),
    ("upgrade", "更新"),
    (
    ...
    ("Hidden features are likely to be obsolete or uninteresting.", ""),
    ("{0} hidden features ({1})", ""),
    ...
    ("通过键入 json Docker 守护程序配置文件来配置 Docker 守护程序 {0}.", ""),
